...
namespace test_delivery {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("Test_Delivery_DBDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class Test_Delivery_DBDataSet : global::System.Data.DataSet {
        ...
        public Test_Delivery_DBDataSet() {
            this.BeginInit();
            this.InitClass();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected Test_Delivery_DBDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            Test_Delivery_DBDataSet cln = ((Test_Delivery_DBDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "Test_Delivery_DBDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Test_Delivery_DBDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            Test_Delivery_DBDataSet ds = new Test_Delivery_DBDataSet();
        ...
        public partial class pacienteDataTable : global::System.Data.TypedTableBase<pacienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public pacienteRow AddpacienteRow(string nome, string telefone, string cpf, string rua, int numero, string bairro, string complemento, string cidade, string estado, string cep) {
...
namespace test_delivery.Test_Delivery_DBDataSetTableAdapters {
    ...
    public partial class pacienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[paciente] WHERE (([paciente_id] = @Original_paciente_id) AND ([nome] = @Original_nome) AND ([telefone] = @Original_telefone) AND ([cpf] = @Original_cpf) AND ([rua] = @Original_rua) AND ([numero] = @Original_numero) AND ([bairro] = @Original_bairro) AND ((@IsNull_complemento = 1 AND [complemento] IS NULL) OR ([complemento] = @Original_complemento)) AND ([cidade] = @Original_cidade) AND ([estado] = @Original_estado) AND ([cep] = @Original_cep))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[paciente] ([nome], [telefone], [cpf], [rua], [numero], [bairro], [complemento], [cidade], [estado], [cep]) VALUES (@nome, @telefone, @cpf, @rua, @numero, @bairro, @complemento, @cidade, @estado, @cep);
SELECT paciente_id, nome, telefone, cpf, rua, numero, bairro, complemento, cidade, estado, cep FROM paciente WHERE (paciente_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[paciente] SET [nome] = @nome, [telefone] = @telefone, [cpf] = @cpf, [rua] = @rua, [numero] = @numero, [bairro] = @bairro, [complemento] = @complemento, [cidade] = @cidade, [estado] = @estado, [cep] = @cep WHERE (([paciente_id] = @Original_paciente_id) AND ([nome] = @Original_nome) AND ([telefone] = @Original_telefone) AND ([cpf] = @Original_cpf) AND ([rua] = @Original_rua) AND ([numero] = @Original_numero) AND ([bairro] = @Original_bairro) AND ((@IsNull_complemento = 1 AND [complemento] IS NULL) OR ([complemento] = @Original_complemento)) AND ([cidade] = @Original_cidade) AND ([estado] = @Original_estado) AND ([cep] = @Original_cep));
SELECT paciente_id, nome, telefone, cpf, rua, numero, bairro, complemento, cidade, estado, cep FROM paciente WHERE (paciente_id = @paciente_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::test_delivery.Properties.Settings.Default.Test_Delivery_DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT paciente_id, nome, telefone, cpf, rua, numero, bairro, complemento, cidade" +
                ", estado, cep FROM dbo.paciente";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT paciente_id, nome, telefone, cpf, rua, numero, bairro, complemento, cidade" +
                ", estado, cep FROM dbo.paciente";
        ...
        public virtual int Fill(Test_Delivery_DBDataSet.pacienteDataTable dataTable) {
        ...
        public virtual Test_Delivery_DBDataSet.pacienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Test_Delivery_DBDataSet.pacienteDataTable dataTable = new Test_Delivery_DBDataSet.pacienteDataTable();
        ...
        public virtual int FillBy(Test_Delivery_DBDataSet.pacienteDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Test_Delivery_DBDataSet.pacienteDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Test_Delivery_DBDataSet dataSet) {
        ...
        public virtual int Delete(int Original_paciente_id, string Original_nome, string Original_telefone, string Original_cpf, string Original_rua, int Original_numero, string Original_bairro, string Original_complemento, string Original_cidade, string Original_estado, string Original_cep) {
        ...
        public virtual int Insert(string nome, string telefone, string cpf, string rua, int numero, string bairro, string complemento, string cidade, string estado, string cep) {
            if ((nome == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_estado, 
                    string Original_cep) {
            return this.Update(nome, telefone, cpf, rua, numero, bairro, complemento, cidade, estado, cep, Original_paciente_id, Original_nome, Original_telefone, Original_cpf, Original_rua, Original_numero, Original_bairro, Original_complemento, Original_cidade, Original_estado, Original_cep, Original_paciente_id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(Test_Delivery_DBDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._pacienteTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(Test_Delivery_DBDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._pacienteTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(Test_Delivery_DBDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._pacienteTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(Test_Delivery_DBDataSet dataSet) {
            if ((dataSet == null)) {
